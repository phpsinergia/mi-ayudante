...
CargarConfigIni() {
	local seccion, claves, valor, disco, lanzamiento
	...
	Config := {}
	Config.Base := {AppDir: A_ScriptDir, Disco: disco, App: "", RutaProyecto: "", IdProyecto: 1, CfgIni: CfgIni, Entorno: valor, Lanzamiento:lanzamiento}
